...
namespace protocol
{
    ...
    constexpr std::size_t VIDEO_CHUNK_SIZE = 4096;
    ...
    constexpr uint8_t FRAME_VIDEO_BEGIN = 6;
    constexpr uint8_t FRAME_VIDEO_CHUNK = 7;
    constexpr uint8_t FRAME_VIDEO_END = 8;
